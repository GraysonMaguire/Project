...
def coreRadiusOverTime(mData, pData, color, label, nBins):
    ...
    axis.plot(time, coreRadii, color=color, label=label)
...
# coreRadiusOverTime(M, P, 'black', '3000', 3000)
coreRadiusOverTime(M, P, 'skyblue', None, 6000)
# coreRadiusOverTime(M, P, 'blue', '5000', 5000)
# coreRadiusOverTime(M, P, 'skyblue', '6000', 6000)
...
plt.legend()
plt.savefig('./saves/coreRadius.png')
plt.show()
